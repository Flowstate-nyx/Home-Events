 ...
 */
async function reserveWithinTransaction(client, tierId, quantity) {
 ...
 */
async function releaseWithinTransaction(client, tierId, quantity) {
  await client.query(
    `UPDATE ticket_tiers 
 ...
 */
async function getTierAvailability(db, tierId) {
 ...
 */
function validateTierPurchase(tier, requestedQty) {
  if (!tier) {
